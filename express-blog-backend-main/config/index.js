...
module.exports = {
    ...
    aiWriter: {
        ...
        baiduSearchModel: process.env.BAIDU_SEARCH_MODEL || "deepseek-v4-flash",
    ...
    petAgent: {
        providerOrder: toArray(process.env.PET_AGENT_PROVIDER_ORDER, ["agnes", "openrouter", "openai", "deepseek"]),
