...
class ArticleService extends ApiService {
    ...
    public pageUser(params: QueryPageModel & { keyword?: string }) {
        return this.$get<PageResponse<ArticleDTO>>("user/page", params);
    }
    ...
    public pageByAuthor(params: QueryPageModel & { authorId: number; keyword?: string }) {
        return this.$get<PageResponse<ArticleDTO>>("page_by_author", params);
    }

    public search(params: QuerySearchModel) {
        return this.$get<PageResponse<ArticleDTO>>("search", params);
    }
